...
namespace MinoRatingPlugin
{
    public class MinoratingPlugin : AcServerPlugin
    {
        ...
        public static Version PluginVersion = new Version(1, 3, 1);
        ...
        protected override void OnLapCompleted(MsgLapCompleted msg)
        {
            ...
            if(_consistencyReports[driver] != null)
            {
        ...
        protected override void OnCarUpdate(DriverInfo di)
        {
            ...
            if(_consistencyReports.ContainsKey(di))
            {
                ...
                var lastSplit = (int)(di.LastCarUpdate.Next.Value.NormalizedSplinePosition * cr.SplitResolution);
                ...
                if(lastSplit != thisSplit && lastSplit < 0.9)
                {
                    ...
                    splits.Add(AverageLaptimeBySplit(di.LastCarUpdate.Next.Value, di.LastCarUpdate.Value));
                }
